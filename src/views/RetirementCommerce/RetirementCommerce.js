...
// Import Constans
import { RFValue, Colors, GlobalStyles, http, errorMessage, getFeePercentage, getHeaders, successMessage, serverSpeedtradingsURL } from '../../utils/constants'
...
const RetirementCommerce = ({ route }) => {
